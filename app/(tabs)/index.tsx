import { Image, StyleSheet, Platform, Button, View, TextInput } from 'react-native';
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <Button title='qweqw' color={"#123"} accessibilityLabel='qweqw' onPress={()=>{router.push("/inventory/(tabs)")}}/>
      </ThemedView>
      <ThemedView style={styles.stepContainer}>
