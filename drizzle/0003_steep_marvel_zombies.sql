...
CREATE TABLE `__new_Cliente` (
	...
	`created_at` text DEFAULT '2026-04-10T03:28:39.302Z' NOT NULL,
	`updated_at` text DEFAULT '2026-04-10T03:28:39.302Z' NOT NULL,
	`deleted_at` text
);
...
CREATE TABLE `__new_Componente` (
	...
	`created_at` text DEFAULT '2026-04-10T03:28:39.303Z' NOT NULL,
	`deleted_at` text
);
--> statement-breakpoint
...
CREATE TABLE `__new_Factura` (
	...
	`pdf_url` text,
	`created_at` text DEFAULT '2026-04-10T03:28:39.303Z' NOT NULL,
	`updated_at` text DEFAULT '2026-04-10T03:28:39.303Z' NOT NULL,
	`deleted_at` text
);
--> statement-breakpoint
...
CREATE TABLE `__new_Pago` (
	...
	`estado` text DEFAULT 'PENDIENTE' NOT NULL,
	`estado_sync` text DEFAULT 'PENDIENTE' NOT NULL,
	`fecha_pago` text DEFAULT '2026-04-10T03:28:39.303Z' NOT NULL,
	`created_at` text DEFAULT '2026-04-10T03:28:39.303Z' NOT NULL,
	`updated_at` text DEFAULT '2026-04-10T03:28:39.303Z' NOT NULL,
	`updated_by_uuid` text,
	`deleted_at` text
...
CREATE TABLE `__new_PerfilNegocio` (
	...
	`created_at` text DEFAULT '2026-04-10T03:28:39.301Z' NOT NULL,
	`updated_at` text DEFAULT '2026-04-10T03:28:39.301Z' NOT NULL,
	`deleted_at` text
);
--> statement-breakpoint
...
CREATE TABLE `__new_Sesion` (
	...
	`ultimo_login` text DEFAULT '2026-04-10T03:28:39.302Z' NOT NULL,
	`activo` integer DEFAULT 1 NOT NULL,
	`estado_sync` text DEFAULT 'PENDIENTE' NOT NULL,
	`deleted_at` text
);
